...
if (!empty($_POST["comment"])){
    ...
    $query = "INSERT INTO payment_transactions (payment_type, date, store_operator, customer, cash, amount_paid, change_amount, entry_no, comment) VALUES ('$paymentType', '$date', '$store_operator', '$customer', '$cash', '$amountPaid', '$change', '$entryNo', '$comment')";
}
else {
    // using "change_amount" instead of "change" because change is a reserved keyword as warned by phpmyadmin
    $query = "INSERT INTO payment_transactions (payment_type, date, store_operator, customer, cash, amount_paid, change_amount, entry_no) VALUES ('$paymentType', '$date', '$store_operator', '$customer', '$cash', '$amountPaid', '$change', '$entryNo')";
}
